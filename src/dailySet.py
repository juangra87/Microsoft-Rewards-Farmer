...
class DailySet:
    ...
    def complete_daily_stuff(self, activity, card_id):
        if (
            ...
            self.complete_poll_and_quiz_card(card_id, search_url_queries)

    def complete_poll_and_quiz_card(self, card_id, search_url_queries):
        filters = {}
